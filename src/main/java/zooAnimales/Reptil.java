...
public class Reptil extends Animal{
    ...
    public void setIguana(int iguanas) {
        this.iguanas = iguanas;
        new Reptil(nombre, edad, "humedal", genero, zona, listado, iguanas, serpientes, "verde", 3);
    }

    public void crearSerpiente(int serpientes) {
        this.serpientes = serpientes;
        new Reptil(nombre, edad, "jungla", genero, zona, listado, iguanas, serpientes, "blanco", 1);
    }
